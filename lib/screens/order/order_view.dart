  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      if(orderController.isLoading==false){
                        ...
                        Row(children: [
                          ...
                          Expanded(
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Row(children: [
                                Text('${'pedido_id'.tr}:', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                            ...
                            isRunning ? InkWell(
                              ...
                              child: Container(
                                ...
                                child: Row(children: [
                                  ...
                                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                  Text('Seguir el pedido'.tr, style: robotoMedium.copyWith(
        ...
        NoDataScreen(text: 'Pedido no encontrado'.tr) ):
